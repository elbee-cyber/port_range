...
nl()
nl()
print("Thank you for using elbee's simple port scanner!")
print("For educational use only. I am not liable for your actions.")
print("Follow me @elbee_ez or my CTF team @AstraCyber on twitter.")
print("Stay cool! B-)")
nl()
nl()
